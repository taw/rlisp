...
(test-suite RLUnit
  (test assert
    ...
    (assert        (assert foo !~ bar)
     macroexpands: [self assert_no_match bar foo])
    (assert        (assert foo !~ bar msg: "Failed")
     macroexpands: [self assert_no_match bar foo "Failed"])
    (assert        (assert foo != bar)
     macroexpands: [self assert_not_equal bar foo])
    (assert        (assert foo != bar msg: "Failed")
     macroexpands: [self assert_not_equal bar foo "Failed"])
    ...
    (assert        (assert foo not-same: bar)
     macroexpands: [self assert_not_same bar foo])
    (assert        (assert foo not-same: bar msg: "Failed")
     macroexpands: [self assert_not_same bar foo "Failed"])
